...
## Application Window
At first i kept using [http://doc.qt.nokia.com/qt-components-symbian/qml-applicationwindow.html ApplcaitonWindow] because it was way more convenient compared to the simple [http://doc.qt.nokia.com/qt-components-symbian/qml-window.html Window] that you needed to implement everything. But ApplcaitonWindow's warning...warned me and changed into the simple Window along with manually adding the so useful [http://doc.qt.nokia.com/qt-components-symbian/qml-pagestack.html PageStack], [http://doc.qt.nokia.com/qt-components-symbian/qml-toolbar.html ToolBar], and [http://doc.qt.nokia.com/qt-components-symbian/qml-statusbar.html StatusBar]

## Storage
The MySql backend of the [http://doc.qt.nokia.com/4.7-snapshot/qdeclarativeglobalobject.html#offline-storage-api Offiline Storage] was the perfect way to store and retrieve all the different data i needed. Guests, Shopping baskets, Todo-lists, User details, Event details...very usefull.
